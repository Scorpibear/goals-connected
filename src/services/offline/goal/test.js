...
describe('/goal', () => {
  ...
  describe('POST /goal', () => {
    it('generated unique goal id if it was not provided', async () => {
      vi.spyOn(Generator, 'getNewId').mockReturnValue('generatedID')
        ...
        goals: [
          {
            ...
            title: 'goal1',
            tags: ['tag1', 'tag2'],
            children: [{ id: expect.anything(), title: 'goal2', tags: ['tag1', 'tag2'] }]
          }
        ]
      })
    })
  ...
  describe('PUT /goal', () => {
    ...
    it('sets quarters parent targetDate if the updated goal targetDate was not provided', async () => {
      vi.setSystemTime(Date.parse('2024-07-01'))
      const inputGoals = {
        goals: [
          {
            id: '1',
        ...
        goals: [
          {
            ...
            title: 'goal1',
            targetDate: '2024-07-31',
            children: [{ id: '1.1', title: 'updated', targetDate: '2024-07-08' }]
          }
        ]
      })
    })
  ...
  describe('PATCH /goal?id=${id}', () => {
    ...
    describe('levelUp', () => {
      ...
      it('moves the goal just after the parent', async () => {
        const inputGoals = {
          goals: [{ id: 'p1' }, { id: 'p2', children: [{ id: 'theGoal' }] }, { id: 'p3' }]
        }
        req = { method: 'PATCH', query: { id: 'theGoal', action: 'levelUp' } }

        await goalFunc(context, req, inputGoals)

        expect(context.bindings.outGoals.goals).toEqual([
          { id: 'p1' },
          { id: 'p2' },
          { id: 'theGoal' },
          { id: 'p3' }

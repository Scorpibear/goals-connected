...
export function getDatePeriods(today) {
  ...
  ;[3, 5, 10, 20, 50].forEach((years) => {
    output.push({
      title: generateYearsLabel(yearLabelFormatter, years),
      end: plusYears(lastDayOfYear, years - 1)
    })
  })
 ...
 */
export function quarterDate(strEndDate, strStartDate = null) {
